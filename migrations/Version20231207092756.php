 ...
 */
final class Version20231207092756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE problem_car ADD car_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_189274F6C3C6F69F');
        $this->addSql('ALTER TABLE problem_car DROP car_id');
    }
}
