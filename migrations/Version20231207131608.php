 ...
 */
final class Version20231207131608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rental (id INT NOT NULL, customer_id INT NOT NULL, employee_id INT DEFAULT NULL, contract BOOLEAN NOT NULL, mileage_kilometers INT NOT NULL, from_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, to_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, price NUMERIC(8, 2) NOT NULL, status INT NOT NULL, uuid UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
